    ...
    const HERO_BACKGROUND_OPTIONS = [
        {
            ...
            image: 'https://images.unsplash.com/photo-1604654894610-df63bc536371?q=60&w=800&auto=format&fit=crop'
        },
        {
            id: 'belleza',
            label: 'Salon de belleza',
            description: 'Para salones generales, spa y estetica.',
            image: 'https://images.unsplash.com/photo-1560750588-73207b1ef5b8?q=60&w=800&auto=format&fit=crop'
        },
        {
            id: 'barberia',
            label: 'Barberia',
            description: 'Para barberias y servicios masculinos.',
            image: 'https://images.unsplash.com/photo-1517832606299-7ae9b720a186?q=60&w=800&auto=format&fit=crop'
        },
        {
            id: 'peluqueria',
            label: 'Salon de peluqueria',
            description: 'Para cortes, color, peinados y tratamientos.',
            image: 'https://images.unsplash.com/photo-1701976333339-1d41dad8138b?ixlib=rb-4.1.0&q=60&fm=jpg&crop=entropy&cs=srgb&w=800&auto=format&fit=crop'
        },
        {
            id: 'lashes',
            label: 'Salon de lashes',
            description: 'Para pestanas, cejas y mirada.',
            image: 'https://images.unsplash.com/photo-1589710751893-f9a6770ad71b?ixlib=rb-4.1.0&q=60&fm=jpg&crop=entropy&cs=srgb&w=800&auto=format&fit=crop'
        }
    ];
