function EditarNegocio() {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gray-100 py-8 px-4" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-4xl mx-auto" }, /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-xl shadow-sm p-6" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-6 pb-4 border-b" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 bg-amber-600 rounded-xl flex items-center justify-center" }, /* @__PURE__ */ React.createElement("i", { className: "icon-building text-2xl text-white" })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h1", { className: "text-2xl font-bold text-gray-900" }, t("Editar Negocio")), /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-500" }, t("Modificá los datos de tu negocio")))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement(window.LanguageToggle, null), /* @__PURE__ */ React.createElement(
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-2" }, t("Imagen de fondo para clientes")), /* @__PURE__ */ React.createElement("div", { className: `rounded-lg border-2 p-3 mb-4 transition ${config.imagen_fondo_url ? "border-amber-600 ring-2 ring-amber-200 bg-amber-50/40" : "border-dashed border-gray-300"}` }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "h-20 w-28 shrink-0 rounded-lg overflow-hidden bg-gray-100 flex items-center justify-center" }, subiendoFondo ? /* @__PURE__ */ React.createElement("span", { className: "text-xs text-gray-500" }, t("Subiendo...")) : config.imagen_fondo_url ? /* @__PURE__ */ React.createElement("img", { src: config.imagen_fondo_url, alt: t("Tu foto de fondo"), className: "h-full w-full object-cover" }) : /* @__PURE__ */ React.createElement("span", { className: "text-2xl" }, "🖼️")), /* @__PURE__ */ React.createElement("div", { className: "min-w-0 flex-1" }, /* @__PURE__ */ React.createElement("p", { className: "text-sm font-semibold text-gray-900" }, t("Tu propia foto")), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-500 mt-1" }, config.imagen_fondo_url ? t("Se está usando tu foto. Las opciones de abajo quedan desactivadas.") : t("Sube una foto de tu salón o tu trabajo. Se verá mejor que las genéricas.")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 mt-2" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      id: "fondo-input",
      type: "file",
  ...
  ), config.imagen_fondo_url && /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    t("Quitar")
  ))))), /* @__PURE__ */ React.createElement("p", { className: "text-xs font-medium text-gray-600 mb-2" }, config.imagen_fondo_url ? t("O vuelve a una imagen genérica (quita tu foto primero)") : t("O elige una imagen genérica")), /* @__PURE__ */ React.createElement("div", { className: `grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 ${config.imagen_fondo_url ? "opacity-50 pointer-events-none" : ""}` }, (window.HERO_BACKGROUND_OPTIONS || []).map((opcion) => /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      key: opcion.id,
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-amber-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-amber-600" }))), config.fidelizacion_activa && /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, t("Cada cuántas citas")), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "number",
      min: "1",
  ...
  )), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "block text-sm font-medium text-gray-700 mb-1" }, t("Descuento (%)")), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "number",
      min: "0",
  ...
  )), /* @__PURE__ */ React.createElement("p", { className: "col-span-2 text-xs text-gray-500" }, t("Con {cada} citas y {pct}%: la clienta completa {cada} citas normales y la {siguiente}.ª tiene {pct}% de descuento.", {
