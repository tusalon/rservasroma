...
const CACHE_NAME = 'rservasroma-v39';
...
const urlsToCache = [
  ...
  `${BASE}/utils/native-push-notifications.js?v=20260721-upsert-endpoint`,
  ...
  `${BASE}/utils/push-notifications.js?v=20260721-upsert-endpoint`,
